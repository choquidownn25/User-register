...
namespace Capa.Presentacion.Extensions
{
    public static class ClaimsExtensions
    {
        ...
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "WebApplicationDrHelp.Models.RegisterViewModel.Email")?.Value;
        }
        ...
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "WebApplicationDrHelp.Models.RegisterViewModel.NameIdentifier")?.Value;
        }
